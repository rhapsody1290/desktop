...
git clone https://github.com/denglixi/hackathon.git denglixi
git clone https://github.com/fcjy/eleme-hackathon.git fcjy
git clone https://github.com/langruixiang/eleme_hackathon.git langruixiang
